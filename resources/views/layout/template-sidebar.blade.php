<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
                    ...
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('/attendance/employee-attendance-list') }}"
                                class="nav-link {{ active_class(['attendance/attendance']) }}">Employee Attendance
                                List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/attendance/branch-employee') }}"
                                class="nav-link {{ active_class(['attendance/attendance']) }}">Branch Employee</a>
                            {{-- </li>
                        <li class="nav-item">
                            <a href="{{ url('/attendance/sales-visit') }}"
                                class="nav-link {{ active_class(['attendance/visit']) }}">Sales Visit</a>
                        </li> --}}
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item {{ active_class(['/katalog']) }}">
                <a href="{{ url('/catalog-product') }}" class="nav-link">
